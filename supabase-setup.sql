...
-- 11. Posts (Tin tức - Bulletin Board)
...
-- 12. Comments (Bình luận - Bulletin Board)
...
INSERT INTO posts (id, tieu_de, noi_dung, tac_gia_id, loai, ghim, created_at) VALUES
  ('00000000-0000-0000-0005-000000000001', 'Thông báo lịch thi giữa kỳ', 'Các em học sinh lớp 3A và 3B chú ý:\n\nLịch thi giữa kỳ II như sau:\n- Thứ 2 (17/02): Toán\n- Thứ 3 (18/02): Tiếng Việt\n- Thứ 4 (19/02): Khoa học', '00000000-0000-0000-0000-000000000001', 'thong-bao', TRUE, '2026-02-12T08:00:00Z'),
  ('00000000-0000-0000-0005-000000000002', 'Hoạt động ngoại khóa: Tham quan Bảo tàng', 'Nhà trường tổ chức chuyến tham quan Bảo tàng Lịch sử vào ngày 22/02/2026.', '00000000-0000-0000-0000-000000000001', 'su-kien', FALSE, '2026-02-11T10:00:00Z')
ON CONFLICT DO NOTHING;
